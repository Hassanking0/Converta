...
const Strategy = () => {
	const [activeImage, setActiveImage] = useState<string>(StrategyImage)
							...
							className={`w-full h-full object-cover transition-all duration-700 ease-in-out transform ${
								isAnimating
									? animationDirection === 'left'
										? 'translate-x-full opacity-0' // Exit to right (for left-to-right animation)
										: '-translate-x-full opacity-0' // Exit to left (for right-to-left animation)
