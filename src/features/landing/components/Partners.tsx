...
const Partners = () => {
	return (
        ...
        {/* desc */}
        <div className='text-lg text-zinc-400 text-center'>We work with organizations of all sizes, from early start-ups to global brands, in <br /> the private, public, and social sector.</div>
        {/* btn */}
