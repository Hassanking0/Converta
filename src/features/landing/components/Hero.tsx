...
const Hero = () => {
	return (
		<div className='hero px-2  md:px-17 flex gap-16 w-full h-120 md:h-160 bg-[#F4F6FB]'>
			<div className='left py-8 md:pl-16 flex flex-col gap-6 justify-center h-120 md:h-160 text-center md:text-start'>
				<div className='title text-4xl md:text-7xl font-bold text-[#321270]'>
				...
				<div className='bts mt-5 flex mx-auto md:mx-0'>
